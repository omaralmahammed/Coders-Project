...
header.innerHTML = `
    ...
    <div class="it-header-transparent">
        ...
        <div
          class="it-header-2-top-area it-header-3-top it-header-2-top-height white-bg"
        >
          <div class="container">
            <div class="row align-items-center">
              <div class="col-xl-8 col-lg-8 col-md-5 col-7">
              ...
              <div class="col-xl-4 col-lg-4 col-md-7 col-5">
        ...
        <!-- header-area-start -->
        <div id="header-sticky" class="it-header-2-area it-header-3-style">
          <div class="container">
            <div class="it-header-2-plr">
              <div class="it-header-wrap p-relative">
                <div class="row align-items-center">
                    ...
                    <div class="it-header-2-main-menu">
                      <nav class="it-menu-content">
                        <ul>
                          ...
                          <li><a href="course-2.html">Programs</a></li>

                          <li><a href="services-3.html">Services</a></li>

                          <li class="has-dropdown">
                            <a>Explore</a>
                            <ul class="it-submenu submenu" style="width: 220px">
                              <li>
                                <a
                                  href="blog-sidebar.html"
                                  onclick="storeCategoryId(1)"
                                  >Blog</a
                                >
                              </li>
                  ...
                  <div id="navBarBefore" class="col-xl-3 col-5">
                    <div
                      class="it-header-2-right d-flex align-items-center justify-content-end"
                    >
                      <div class="it-header-2-button d-none d-md-block">
                        <a class="it-btn-yellow" href="signin.html">
                          <span> Log in </span>
                        </a>
                      </div>

                      <div class="it-header-2-button d-none d-md-block">
                        <a class="it-btn-white" href="signup.html">
                          <span> Sign up </span>
                        </a>
                      </div>
                    </div>
                  ...
                  <div id="navBarAfter" class="col-xl-3 col-5">
                    <div
                      class="it-header-2-left d-flex align-items-center justify-content-end"
                    >
                      <div class="it-header-2-main-menu">
                        <nav class="it-menu-content">
                          <ul class="it-menu">
                            <li class="has-dropdown">
                              ...
                              <ul
                                class="it-submenu submenu"
                                style="left: -110px; width: 220px"
                              >
                                <li>
...
if (UserId) {
  document.getElementById("navBarBefore").style.display = "none";
  document.getElementById("navBarAfter").style.display = "block";
} else {
  document.getElementById("navBarBefore").style.display = "block";
  document.getElementById("navBarAfter").style.display = "none";
}
